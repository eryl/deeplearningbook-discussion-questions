...
2.  With the same example of as the previous question, could the two networks (convnet vs. fully connected net) to learn the same function? If yes, how? If no, why not?